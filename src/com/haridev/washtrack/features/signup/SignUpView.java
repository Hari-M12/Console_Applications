...
public class SignUpView {
    ...
    private void startSignUp() {
        System.out.println();
        System.out.println("Create your WashTrack account");
        ...
        signUpModel.registerEmployee(name, email, password, mobile, dob, role, address);
    }
    ...
    private String promptAddress() {
        while (true) {
            ...
            String input = scanner.nextLine();
            String error = signUpModel.validateAddress(input);
            if (error == null) return input.trim();
            showErrorMessage(error);
        }
    }
    ...
    private Role promptRole() {
        while (true) {
            ...
            String input = scanner.nextLine();
            Role role = signUpModel.parseRole(input);
